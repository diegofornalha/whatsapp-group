...
export class AnalyticsDashboard {
    ...
    addStyles() {
        if (document.getElementById('mcp-dashboard-styles'))
            return;
    ...
    initializeCharts() {
        ...
        const growthCtx = this.container.querySelector('#growth-chart');
        if (growthCtx) {
        ...
        const distributionCtx = this.container.querySelector('#distribution-chart');
        if (distributionCtx) {
        ...
        const predictionsCtx = this.container.querySelector('#predictions-chart');
        if (predictionsCtx) {
    ...
    async exportData(format) {
        try {
            const button = this.container.querySelector(`[data-format="${format}"]`);
            if (button) {
...
export function createAnalyticsDashboard(mcpClient) {
