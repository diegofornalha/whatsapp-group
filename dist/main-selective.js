import { exportToCsv, ListStorage, UIContainer, createCta, createSpacer, createTextSpan, HistoryTracker, LogCategory } from 'browser-scraping-utils';
...
function cleanDescription(description) {
    ...
    if (!descriptionClean.match(/Loading About/i) &&
    ...
    const callback = (mutationList) => {
        ...
        for (const mutation of mutationList) {
            if (mutation.type === "childList") {
                if (mutation.addedNodes.length > 0) {
                    ...
                    if (text) {
                        ...
                        if (textClean.length > 0) {
                            if (!textClean.match(/Loading About/i) &&
                ...
                if (['div'].indexOf(tagName.toLowerCase()) === -1 ||
...
main();
//# sourceMappingURL=main-selective.js.map