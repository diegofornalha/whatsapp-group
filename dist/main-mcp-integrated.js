                ...
                <div class="analytics-grid">
                    ...
                    <div class="metric-card">
                        ...
                        <div class="pattern-list">
                            ${analytics.metrics.patterns.map(p => `<div class="pattern-item">${p.name}: ${p.count}</div>`).join('')}
                        </div>
                    </div>
                    <div class="metric-card">
                        <h3>Previsões (7 dias)</h3>
                        <div class="predictions">
                            ${analytics.metrics.predictions.map(p => `<div>+${p.expected} membros (${p.confidence}% confiança)</div>`).join('')}
                        </div>
                    </div>
                </div>
            `;
...
//# sourceMappingURL=main-mcp-integrated.js.map